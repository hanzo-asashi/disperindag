...
class XRenderAction extends CAction
{
     ...
     * @param bool whether to terminate the current application after calling this method
     * @param int the HTTP status code. Defaults to 302. See {@link http://www.w3.org/Protocols/rfc2616/rfc2616-sec10.html}
     ...
     * @param bool whether the rendering result should be returned instead of being displayed to end users.
     *
     ...
     * @param array data to be extracted into PHP variables and made available to the view script
     * @param bool whether the rendering result should be returned instead of being displayed to end users
     * @param bool whether the rendering result should be postprocessed using {@link processOutput}.
     *
     * @return string the rendering result. Null if the rendering result is not required.
     *
