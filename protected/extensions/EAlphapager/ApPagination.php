...
class ApPagination extends CComponent
{
    ...
    /**
     * @param int the zero-based index of the current page.
     */
     ...
     * @param int the page that the URL should point to. This is a zero-based index.
     *
    ...
    /**
     * @param int ordinal number of the character. zero-based indexing.
     *
    ...
    /**
     * @param int ordinal number of the character whose db character equivalent should be returned. zero-based indexing.
     *
