...
{
    /**
     * @var bool whether to enable alphapagination. Note that if the {@link IDataProvider::alphapagination} property
    ...
    public function renderAlphapager()
    {
        ...
        } elseif (is_array($this->alphaPager)) {
