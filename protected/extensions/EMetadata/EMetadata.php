...
class Metadata extends CApplicationComponent
{
    ...
    */
    ...
    {
        if ($module != null) {
            $path = implode(DIRECTORY_SEPARATOR, array(Yii::app()->modulePath, $module, 'controllers'));
    ...
    */
    private function setModuleIncludePaths($module)
    {
        set_include_path(implode(PATH_SEPARATOR, array(
            ...
            implode(DIRECTORY_SEPARATOR, array(Yii::app()->modulePath, $module, 'components')),
            implode(DIRECTORY_SEPARATOR, array(Yii::app()->modulePath, $module, 'models')),
            implode(DIRECTORY_SEPARATOR, array(Yii::app()->modulePath, $module, 'vendors')),
        )));
    }
    ...
    * @return array
    */
    public function getControllersActions($module = null)
    {
    ...
    */
    ...
    {
        if ($module != null) {
            $path = implode(DIRECTORY_SEPARATOR, array(Yii::app()->modulePath, $module, 'models'));
        } else {
