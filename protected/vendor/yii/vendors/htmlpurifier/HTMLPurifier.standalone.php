...
class HTMLPurifier_Queue {
    ...
    /**
     * Shifts an element off the frontend of the queue.
     */
    ...
    /**
     * Pushes an element onto the frontend of the queue.
     */
    ...
    private function _splitText($data, &$result)
    {
        ...
        for ($i = 0; $i < $c; $i++) {
            ...
            if (trim($par) !== '') {
                ...
                if ($i == 0) {
                    // Double newline at the frontend
                    if (empty($result)) {
    ...
    public function parseAttributeString($string, $config, $context)
    {
        ...
        while ($cursor < $size) {
            ...
            if ($first_char == '=') {
                ...
                // we might be in frontend of a quote right now
