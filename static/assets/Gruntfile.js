    ...
    concat: {
      ...
      vendor: {
        src: [
          ...
          'libs/js/neon-api.js',
          'libs/js/jvectormap/jquery-jvectormap-1.2.2.min.js',
          'libs/js/jvectormap/jquery-jvectormap-europe-merc-en.js',
          'libs/js/jquery.sparkline.min.js',
          'libs/js/raphael-min.js',
