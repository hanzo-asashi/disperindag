		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 title">
					<h1>Sejarah Kota Makassar</h1>
				</div>
				
				<div class="col-md-8">
					<img src="img/page/makassar_disperindag.png" alt="">
					<p>
					...
					<p>
						<i>Sumber: <a href="http://makassarkota.go.id/105-sejarahkotamakassar.html" target="_blank">http://makassarkota.go.id/105-sejarahkotamakassar.html</a></i>
					</p>
				</div>
